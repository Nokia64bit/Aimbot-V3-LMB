--[[
    ...
    Edited: LMB trigger with 200ms hold support — for Mac trackpad users
]]
...
getgenv().ExunysDeveloperAimbot = {
    ...
    Settings = {
        ...
        TriggerKey = Enum.UserInputType.MouseButton1,  -- LMB
        Toggle = false
    },
...
function Environment.Exit(self)
    assert(self, "EXUNYS_AIMBOT.Exit: Missing parameter #1 \"self\" <table>.")
...
function Environment.Blacklist(self, Username)
    assert(self, "EXUNYS_AIMBOT.Blacklist: Missing parameter #1 \"self\" <table>.")
    assert(Username, "EXUNYS_AIMBOT.Blacklist: Missing parameter #2 \"Username\" <string>.")
    Username = FixUsername(Username)
    assert(Username, "EXUNYS_AIMBOT.Blacklist: User "..Username.." couldn't be found.")
    self.Blacklisted[#self.Blacklisted + 1] = Username
end

function Environment.Whitelist(self, Username)
    assert(self, "EXUNYS_AIMBOT.Whitelist: Missing parameter #1 \"self\" <table>.")
    assert(Username, "EXUNYS_AIMBOT.Whitelist: Missing parameter #2 \"Username\" <string>.")
    Username = FixUsername(Username)
    assert(Username, "EXUNYS_AIMBOT.Whitelist: User "..Username.." couldn't be found.")
    local Index = tablefind(self.Blacklisted, Username)
    assert(Index, "EXUNYS_AIMBOT.Whitelist: User "..Username.." is not blacklisted.")
